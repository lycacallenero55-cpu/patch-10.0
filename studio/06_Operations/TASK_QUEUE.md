...
| TASK-0008 | Adaptation-variance record (prose vs EP1 readers) | IN_REVIEW (⑤ gate) | P2 | ② Lore (+⑤ verify) | — | no | same-event/compressed/reordered table |
...
| TASK-0017 | EP.2 "Last Day" script OUTLINE proposal (beat map, DRAFT, WORK_IN_PROGRESS/) — prep for TASK-0005 | IN_REVIEW (⑤ gate) | P1 | ② Lore | — | no (proposal only; script itself stays gated on TASK-0001) | Q-02 keepsake choice stays UNDECIDED — present options for Owner |
