...
| TASK-0008 | Adaptation-variance record (prose vs EP1 readers) | IN_PROGRESS (CYCLE-0002 ② — QA-04 correction, then re-gate) | P2 | ② Lore (+⑤ verify) | — | no | same-event/compressed/reordered table |
...
| TASK-0017 | EP.2 "Last Day" script OUTLINE proposal (beat map, DRAFT, WORK_IN_PROGRESS/) — prep for TASK-0005 | IN_PROGRESS (CYCLE-0002 ②) | P1 | ② Lore | — | no (proposal only; script itself stays gated on TASK-0001) | Q-02 keepsake choice stays UNDECIDED — present options for Owner |
| TASK-0018 | Trailer v2 gap specs DRAFT: 3 environment plates (KF-03/04/12), monster/extinction-content design (KF-07/08), registry-card UI (KF-15) | IN_PROGRESS (CYCLE-0002 ③) | P1 | ③ Visual | — | YES (locks later, per-item) | spec-draft only; no locks, no generation |
